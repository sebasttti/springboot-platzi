...
--
-- Host: 127.0.0.1    Database: platzi_market
-- ------------------------------------------------------
...
INSERT INTO `clientes` VALUES ('2552243','Galileo','Galilei',3462257293,'Cl 1 # 11 - 11','gali@leo.com'),('4546221','Johannes','Kepler',3104583224,'Cl 3 # 33 - 33','kepler@me.com'),('983824','Nicolás','Copernico',3019392466,'Cl 2 # 22 - 22','nico@cope.com');
...
INSERT INTO `compras` VALUES (1,'4546221','1992-08-10 21:30:00','E','','P');
...
CREATE TABLE `compras_productos` (
  ...
  CONSTRAINT `compras_productos_ibfk_1` FOREIGN KEY (`id_compra`) REFERENCES `compras` (`id_compra`),
  CONSTRAINT `compras_productos_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `compras_productos` VALUES (1,1,10,3000.00,1),(1,36,1,40000.00,1),(1,27,1,9000.00,1),(1,49,2,16400.00,1),(1,24,1,4000.00,1);
...
-- Dump completed on 2023-05-08  8:41:18
